 ...
 * PRODUCTOS
 */
router.get('/api/login/productos', (req, res) => {
...
router.post('/api/login/productos', upload.single('myfile'), (req, res, next) => {
    const file = req.file;
    console.log(file)
    if(!file) {
...
router.get('/productos-test', (req, res) => {
    ...
    products.addProducts(allProducts);
...
router.post('/api/signup', upload.single('photo'), passport.authenticate('signup', {
    successRedirect: '/api/login',
 ...
 * COMPRO PRODUCTOS
 */
router.post('/api/login/comprar', (req, res) => {
    const { title, price, myfile } = req.body;
